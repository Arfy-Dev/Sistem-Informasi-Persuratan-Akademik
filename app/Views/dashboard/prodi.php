                                                ...
                                                <div class="card-body">
                                                    <div>
                                                        <form action="<?='/prodi/update/'. $result['id_prodi']?>"
                                                            ...
                                                            <div class="form-group">
                                                                <input id="id_fakultas autorefresh" name="id_fakultas"
                                                                    type="hidden" class="form-control " autofocus=""
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input value="<?= $result['nama']?>" id="nama" required
                                                                    type="text" class="form-control " autofocus=""
                                                                    aria-describedby="namaHelp" name="nama"
                                                                    onkeydown="return /[A-Z, a-z]/.test(event.key)"
                                                                    data-form-type="other">
                                                                <div class="invalid-feedback">
                                                                    Harap isi nama Anda!
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input value="<?= $result['alamat_prodi']?>" value="oke"
