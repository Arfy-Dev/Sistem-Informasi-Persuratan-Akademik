                            ...
                            <div class="modal-body">
                                <div>
                                    <div class="card card-outline p-4">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <form action="<?='/prodi/save'?>" class="needs-validation" method="post"
                                                    id="form" novalidate="novalidate">
                                                    <div class="form-group">
                                                        <label for="id_prodi" class="harus">ID Prodi</label>
                                                        <input value="" id="
                                                                    id_prodi" type="text" required
                                                            class="form-control " autofocus=""
                                                            aria-describedby="id_prodiHelp" name="id_prodi"
                                                            data-form-type="other">
                                                        <div class="invalid-feedback">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="nama" class="harus">Nama Prodi</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="alamat_prodi" class="harus">Alamat Prodi</label>
                                                        <input name="alamat_prodi" type="text" required
                                                            class="form-control " autofocus=""
                                                            aria-describedby=" alamat_prodiHelp" data-form-type="other">
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="id_fakultas" required
                                                            ...
                                                            <option value="" data-select2-id="3">Pilih Fakultas</option>
                                                            ...
                                                            <form action="<?='/prodi/update/'. $result['id_prodi']?>"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="id_prodi autorefresh" name="id_prodi"
                                                                        ...
                                                                        autofocus="" aria-describedby="id_prodiHelp"
                                                                        value="<?= $result['id_prodi']?>"
                                                                        data-form-type="other">
                                                                </div>
                                                                <div class="invalid-feedback">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="id_fakultas" required
                                                                        ...
                                                                        <option value="" data-select2-id="3">
                                                                            <?= $result['id_fakultas']?></option>
                                                                        <?php foreach($data_fakultas as $dataFakultas):?>
                                                                        <option
                                                                            value="<?= $dataFakultas['id_fakultas']?>">
                                                                            <?= $dataFakultas['nama']?>
                                                                        </option>
                                                                        <?php endforeach?>
                                                                    </select>
